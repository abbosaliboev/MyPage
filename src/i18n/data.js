...
export const globalProgramsText = [
  ...
  },
  {
    ...
    award: 'Gold Award',
    description: {
      en: 'Selected for the 13th Summer Program for Innovative Engineering Design (SP!ED 2025), a multinational South Korea–China–Japan engineering design program. Served as Team Leader of the multinational team "One Asia", which designed an AI Smart Crosswalk system, collected real-world data on-site in China, and won the Gold Award.',
      ko: '한·중·일 다국적 공학 설계 프로그램인 제13회 SP!ED 2025에 선발되었습니다. 다국적 팀 "One Asia"의 Team Leader를 맡았으며, 팀은 AI Smart Crosswalk 시스템을 설계하고 중국 현지에서 실환경 데이터를 수집해 Gold Award를 수상하였습니다.',
      ru: 'Отобран для участия в 13-й летней программе инновационного инженерного проектирования (SP!ED 2025) — многонациональной программе Корея–Китай–Япония. Был Team Leader многонациональной команды "One Asia", которая разработала систему AI Smart Crosswalk, собрала данные в реальных условиях в Китае и завоевала Gold Award.',
      uz: "Koreya–Xitoy–Yaponiya ko'pmillatli muhandislik dizayni dasturi bo'lgan 13-SP!ED 2025 yozgi dasturiga tanlab olindim. Ko'pmillatli \"One Asia\" jamoasining Team Leaderi bo'ldim; jamoa AI Smart Crosswalk tizimini loyihalashtirdi, Xitoyda haqiqiy sharoitda ma'lumot to'pladi va Gold Award'ni qo'lga kiritdi.",
    },
    link: 'https://github.com/abbosaliboev/AI_Smart_Crosswalk.git',
  },
];
