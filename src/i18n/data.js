...
export const globalProgramsText = [
  {
    ...
    description: {
      en: 'Represented Chungbuk National University in a three-week international program (CBNU, South Korea → Toulouse, France) combining conference, team project, research, and poster presentation tracks. Led a 4-person team to build MobiCare, an Edge AI real-time fall-detection and alert system combining Deep Learning (YOLO11n-pose + ST-GCN) with a kinematics-based verification filter, presented a paper at ICCAS 2026 and a poster at EKC 2026, and won 2nd place among all team projects in the program.',
      ko: '3주간의 국제 프로그램(충북대학교, 한국 → 프랑스 툴루즈)에 충북대학교 대표로 참가하여 학회, 팀 프로젝트, 연구, 포스터 발표 트랙을 모두 수행했습니다. 4인 팀을 이끌고 Deep Learning(YOLO11n-pose + ST-GCN)과 Kinematics 기반 검증 필터를 결합한 엣지 AI 실시간 낙상 감지·알림 시스템 MobiCare를 개발해 ICCAS 2026에서 논문을, EKC 2026에서 포스터를 발표했으며 전체 팀 프로젝트 중 2등을 수상했습니다.',
      ru: 'Представлял Чхунбукский национальный университет в трёхнедельной международной программе (CBNU, Южная Корея → Тулуза, Франция), включающей конференцию, командный проект, исследование и постерную презентацию. Возглавил команду из 4 человек и разработал MobiCare — систему обнаружения падений и оповещения на Edge AI в реальном времени, сочетающую Deep Learning (YOLO11n-pose + ST-GCN) с фильтром верификации на основе кинематики, представил доклад на ICCAS 2026 и постер на EKC 2026, команда заняла 2-е место среди всех командных проектов программы.',
      uz: "Uch haftalik xalqaro dastur (CBNU, Janubiy Koreya → Tuluza, Fransiya) doirasida Chungbuk Milliy Universitetini vakillik qildim; dastur konferensiya, jamoaviy loyiha, tadqiqot va poster taqdimoti bosqichlarini o'z ichiga oldi. 4 kishilik jamoaga rahbarlik qilib, Deep Learning (YOLO11n-pose + ST-GCN) va kinematika asosidagi tekshiruv filtrini birlashtirgan Edge AI real-time yiqilishni aniqlash va ogohlantirish tizimi MobiCare'ni yaratdim, ICCAS 2026'da maqola va EKC 2026'da poster taqdim etdim, dasturdagi barcha jamoaviy loyihalar orasida 2-o'rinni qo'lga kiritdik.",
    },
    link: 'https://github.com/abbosaliboev/ICCAS_2026',
  },
  {
